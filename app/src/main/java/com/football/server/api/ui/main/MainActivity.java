...
package com.football.server.api.ui.main;
...
import com.football.server.api.ui.base.BaseActivity;
import com.football.server.api.ui.custom.RoundedImageView;
...
import com.football.server.api.utils.ScreenUtils;
...
public class MainActivity extends BaseActivity implements MainMvpView {
    ...
    public void onBackPressed() {
        ...
        if (fragment == null) {
            ...
            if (fragment == null) {
                ...
                onFragmentDetached(UserFragment.TAG);
            }
        } else {
    ...
    public void openUserActivity() {
        ...
        getSupportFragmentManager()
                ...
                .disallowAddToBackStack()
                .setCustomAnimations(R.anim.slide_left, R.anim.slide_right)
                .add(R.id.cl_root_view, UserFragment.newInstance(), UserFragment.TAG)
                .commit();
    }
